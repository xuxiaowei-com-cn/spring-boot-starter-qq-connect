 ...
 */
public class QQWebsiteAuthenticationToken extends AbstractAuthenticationToken {
	...
	public QQWebsiteAuthenticationToken(Collection<? extends GrantedAuthority> authorities,
		...
		this.authorizationGrantType = OAuth2QQWebsiteAuthenticationToken.QQ_WEBSITE;
