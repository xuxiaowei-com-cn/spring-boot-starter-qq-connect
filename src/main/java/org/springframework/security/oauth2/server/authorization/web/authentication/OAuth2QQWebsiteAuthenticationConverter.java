...
/**
 * QQ OAuth2 用于验证授权授予的 {@link OAuth2QQWebsiteAuthenticationToken}。
 *
 * @author xuxiaowei
 * @since Joe Grandja
 * @since 0.0.1
...
public class OAuth2QQWebsiteAuthenticationConverter implements AuthenticationConverter {
	...
	public Authentication convert(HttpServletRequest request) {
		...
		if (!OAuth2QQWebsiteAuthenticationToken.QQ_WEBSITE.getValue().equals(grantType)) {
			return null;
		}
