 ...
 */
public interface QQWebsiteService {
	 ...
	 * 拦截处理此异常
	 */
	QQWebsiteProperties.QQWebsite getQQWebsiteByAppid(String appid) throws OAuth2AuthenticationException;
	 ...
	 * 拦截处理此异常
	 */
	QQWebsiteTokenResponse getAccessTokenResponse(String appid, String code, String state, String binding,
